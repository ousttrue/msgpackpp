...
TEST_CASE("func0") {
  ...
  REQUIRE(msgpackpp::deserialize<int>(client.request_async("zero").get()) == 0);
...
TEST_CASE("func1") {
  ...
  msgpackpp::rpc client;
  client.attach(std::move(socket));
  auto req = client.request_async("acc", 1);
  req.wait();
...
TEST_CASE("func2") {
  ...
  msgpackpp::rpc client;
  client.attach(std::move(socket));
  REQUIRE(msgpackpp::deserialize<int>(client.request_async("add", 3, 4).get()) == 7);
...
TEST_CASE("func3") {
  ...
  msgpackpp::rpc client;
  client.attach(std::move(socket));
  REQUIRE(msgpackpp::deserialize<int>(client.request_async("add3", 3, 4, 5).get()) ==
          12);
...
TEST_CASE("func4") {
  ...
  msgpackpp::rpc client;
  client.attach(std::move(socket));
  REQUIRE(msgpackpp::deserialize<int>(client.request_async("add4", 3, 4, 5, 6).get()) ==
          18);
